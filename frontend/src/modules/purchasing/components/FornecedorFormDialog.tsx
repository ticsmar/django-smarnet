...
import { FormCombobox, FormGrid, FormInput } from "@/components/ui/forms";
        ...
        <form className="space-y-4" onSubmit={handleSubmit}>
          <FormGrid cols={2}>
            <div className="sm:col-span-2">
              <FormInput
                id="razao_soc"
                label={t("compras.col.razao_social")}
                required
            ...
            <FormInput
              id="nome_reduz"
              label={t("compras.col.nome_reduzido")}
              required
