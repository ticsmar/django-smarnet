      ...
      <div className="space-y-6">
        ...
        <div className="rounded-2xl border border-border/50 bg-card p-6 shadow-sm">
          ...
          {!canViewFornecContato ? (
            <EmptyState
              className="mt-6"
              title={t("compras.contatos.no_list_permission")}
            />
          ) : contatosLoading ? (
            <EmptyState
              className="mt-6"
              variant="loading"
              title={t("compras.contatos.loading")}
            />
          ) : !contatosData || contatosData.items.length === 0 ? (
            <EmptyState
              className="mt-6"
              title={t("compras.contatos.empty")}
            />
          ) : (
            <div className="mt-6">
              <Table>
