...
@patch("shared.presentation.auth.permissions.resolve_django_user_from_request")
@patch("users.presentation.views.admin_views.build_list_users_use_case")
...
@patch("shared.presentation.auth.permissions.resolve_django_user_from_request")
@patch("users.presentation.views.admin_views.build_create_user_admin_use_case")
...
@patch("shared.presentation.auth.permissions.resolve_django_user_from_request")
@patch("users.presentation.views.admin_views.build_set_user_groups_use_case")
...
@patch("shared.presentation.auth.permissions.resolve_django_user_from_request")
@patch("users.presentation.views.admin_views.build_list_groups_use_case")
...
def me_access_mocks() -> Generator[MagicMock]:
    with (
        patch("users.presentation.dependencies.build_oracle_auth_repository") as auth,
        patch("users.presentation.dependencies.build_oracle_user_repository") as user,
        patch(
            "users.presentation.serializers.auth_serializers.is_branch_manager_for_username",
            return_value=False,
        ),
        patch(
            "users.presentation.serializers.auth_serializers.is_access_admin_for_username",
            return_value=True,
        ),
        patch(
            "users.presentation.serializers.auth_serializers.get_groups_for_username",
            return_value=["access_admins"],
        ),
        patch(
            "users.presentation.serializers.auth_serializers.resolve_django_user_by_username",
            return_value=MagicMock(is_superuser=False),
        ),
        patch(
            "users.presentation.serializers.auth_serializers.build_user_security_repository",
        ) as mock_security,
    ):
