...
from shared.presentation.auth.permissions import IsOracleAuthenticated
from users.application.dtos.change_password_input_dto import ChangePasswordInputDTO
