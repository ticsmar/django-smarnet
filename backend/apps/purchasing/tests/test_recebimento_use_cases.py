...
from apps.purchasing.application.dtos.recebimento_dtos import GravaFornecContatoInputDTO
...
from apps.purchasing.domain.repositories.recebimento_repository import (
