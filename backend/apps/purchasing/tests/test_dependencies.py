...
from apps.purchasing.application.use_cases.ativa_fornecedor_use_case import (
    AtivaFornecedorUseCase,
)
from apps.purchasing.application.use_cases.exclui_fornec_contato_use_case import (
    ExcluiFornecContatoUseCase,
)
from apps.purchasing.application.use_cases.get_fornec_contato_use_case import (
    GetFornecContatoUseCase,
)
from apps.purchasing.application.use_cases.get_fornecedor_use_case import (
    GetFornecedorUseCase,
)
from apps.purchasing.application.use_cases.get_pais_use_case import GetPaisUseCase
from apps.purchasing.application.use_cases.grava_fornec_contato_use_case import (
    GravaFornecContatoUseCase,
)
from apps.purchasing.application.use_cases.grava_fornecedor_use_case import (
    GravaFornecedorUseCase,
)
from apps.purchasing.application.use_cases.inativa_fornecedor_use_case import (
    InativaFornecedorUseCase,
)
from apps.purchasing.application.use_cases.list_fornec_contatos_use_case import (
    ListFornecContatosUseCase,
)
from apps.purchasing.application.use_cases.list_fornecedores_use_case import (
    ListFornecedoresUseCase,
)
from apps.purchasing.application.use_cases.list_msg_erros_use_case import (
    ListMsgErrosUseCase,
)
from apps.purchasing.application.use_cases.list_paises_use_case import ListPaisesUseCase
from apps.purchasing.presentation.dependencies import (
