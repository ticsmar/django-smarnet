...
from apps.purchasing.infrastructure.repositories.oracle_recebimento_repository_impl import (
...
@patch(
    "apps.purchasing.infrastructure.repositories.oracle_recebimento_repository_impl.connections"
)
