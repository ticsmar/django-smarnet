...
from apps.administracao.domain.repositories.cnpj_consulta_gateway import CepWsRecord
from apps.administracao.domain.services.cnpj_receita import (
    CEP_LENGTH,
    digits_only,
    strip_accents,
)
from apps.administracao.infrastructure.cnpj_consulta.http_json import get_json
