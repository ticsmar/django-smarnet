...
from apps.users.domain.exceptions.auth_exceptions import UserAlreadyExistsError
from apps.users.domain.repositories.user_admin_repository import AdminUserRecord
...
def test_create_user_admin_skips_password_change_flag_when_disabled() -> None:
    ...
    CreateUserAdminUseCase(repository, user_repository, security_repository).execute(
