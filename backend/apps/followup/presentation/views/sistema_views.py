"""Settings API for follow-up systems."""
...
from apps.followup.presentation.serializers.sistema_serializers import (
...
class SistemaCollectionView(APIView):
    ...
    def get(self, request: Request) -> Response:
        ...
        payload = [SistemaSerializer(asdict(item)).data for item in items]
